...
public class CadastroPeca extends javax.swing.JFrame {
    ...
    public static PilhaPeca pilhaPeca = new PilhaPeca(25);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            if(aux2 == false){
                throw new Exception ("ERRO - Valor digitado não é tipo de peca correto(Placa de vídeo,Placa mãe,Processador,Gabinete,HD,SSD,Memoria.");
            }
        ...
        JOptionPane.showMessageDialog(null, pecaLista.getListaPecas().toString());
        textMarca.setText("");
        textValue.setText("");
        textNome.setText("");
